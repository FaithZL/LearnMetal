...
// Structure defining an argument buffer which specifies a list of textures to encode
...
updateInstances(uint                           instanceID       [[ thread_position_in_grid ]],
                ...
                device SourceTextureArguments  &source_textures [[ buffer(AAPLComputeBufferIndexSourceTextures)]],
