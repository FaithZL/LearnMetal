...
(
    ...
    constant ParticleVertexIn* sandVB [[buffer(10)]], // Sand
    constant ParticleVertexIn* grassVB [[buffer(11)]], // Grass
    constant ParticleVertexIn* rockVB [[buffer(12)]], // Rock
    constant ParticleVertexIn* snowVB [[buffer(13)]] // Snow
)
{
