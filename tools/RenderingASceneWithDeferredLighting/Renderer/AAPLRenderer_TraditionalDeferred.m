...
- (void)loadMetal
{
    ...
    // Whatever rendered in the final pass needs to be store so it can be displayed
...
{
    // Platform independent code allocates all GBuffers >except< lighting GBuffer (since with the
